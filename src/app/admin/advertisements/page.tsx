              ...
              {filteredAds.length > 0 ? (
                ...
                <div className="p-6 text-center">
                  <div className="text-gray-400 mb-4">
                    {activeTab === 'banner' && <Image className="h-12 w-12 mx-auto" alt="" />}
                    {activeTab === 'carousel' && <Sliders className="h-12 w-12 mx-auto" alt="" />}
                    {activeTab === 'featured' && <Star className="h-12 w-12 mx-auto" alt="" />}
                  </div>
